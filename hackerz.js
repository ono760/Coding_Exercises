...
app.get('/:operation/:x/:y', function(req, res){
    ...
    try {
      var result = eval(req.params.x + operator + req.params.y); //Here is the vulnerability.  eval is converting string to number. "eval is evil"
...
//to kill server, in URL, /add/process.exit()/2
