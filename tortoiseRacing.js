...
function race(v1, v2, g) {
    ...
    var catchUpTime = Math.floor(g / (v2 - v1) * 3600); // = lead, which is distance between A & B. So, lead/v2 - v1
    var hours = Math.floor(catchUpTime / 3600);
    var minutes = Math.floor((catchUpTime - hours * 3600) / 60);
    var seconds = catchUpTime - hours * 3600 - minutes * 60;
    timeToCatchUp.push(hours, minutes, seconds);
