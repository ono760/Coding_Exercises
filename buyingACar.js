...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth) {
    var numOfMonths = 0;
    var initialCash = startPriceOld;
    while (initialCash < startPriceNew) {
        initialCash += savingperMonth;
        initialCash -= startPriceOld * percentLossByMonth / 100;
    ...
    return [numOfMonths, Math.floor(initialCash - startPriceNew)];
