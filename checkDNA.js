...
seq1 = 'CGATACGAACCCATAATCG';
seq2 = 'CTACACCGGCCGATTATGG';
seq3 = 'GCGCTGCTAGCTGATCGA';
seq4 = 'ACGTACGATCGATCAGCTAGCAGCGCTAC';
...
function checkDNA(seq1, seq2) {
    ...
    seq2 = Array.prototype.map.call(seq2, function(current) {
        return dnaPairs[current];
    }).reverse().join('');

    if (seq1.length >= seq2.length) {
        return seq1.indexOf(seq2) !== -1;
    } else {
        return seq2.indexOf(seq1) !== -1;
    }
}

console.log(checkDNA(seq1, seq2));
console.log(checkDNA(seq3, seq4));
